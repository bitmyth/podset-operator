...
```sh
make build-installer IMG=<some-registry>/podset-operator:tag
```
...
```sh
kubectl apply -f https://raw.githubusercontent.com/<org>/podset-operator/<tag or branch>/dist/install.yaml
```
